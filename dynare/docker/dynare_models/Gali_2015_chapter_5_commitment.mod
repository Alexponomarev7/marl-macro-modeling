/*
 * Optimal monetary policy under commitment in the basic New Keynesian model of Jordi Gali (2015):
...
ramsey_model(instruments=(NominalInterestRate), planner_discount=betta);
